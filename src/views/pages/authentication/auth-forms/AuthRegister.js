      ...
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            const registerResp = await CoreApi.createAccount(values.email, values.password, values.confirmPassword, values.company);

            if (registerResp?.success) {
              await login(values.email, values.password);
            } else {
              setErrors(registerResp.errors);
            }
            setSubmitting(false);
          } catch (err) {
            console.error(err);
      ...
      >
        {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
          <form noValidate onSubmit={handleSubmit} {...others}>
            ...
            >
              <InputLabel htmlFor="outlined-adornment-confirm-password-register">Password</InputLabel>
              <OutlinedInput
